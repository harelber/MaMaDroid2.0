...
#this function removes the features of mamadroid to test mamadroid 2.0
def rem_mamadroid(df):
        to_erase=df.filter(like='To').columns
        return df.drop(columns=to_erase)
...
df_mal_test1=rem_mamadroid(df_mal_test1)
df_ben_train=rem_mamadroid(df_ben_train)
df_mal_test_java=rem_mamadroid(df_mal_test_java)
df_mal_test_old=rem_mamadroid(df_mal_test_old)
ben_test=rem_mamadroid(ben_test)
df_mal_train=rem_mamadroid(df_mal_train)
df_mal_test_xml=rem_mamadroid(df_mal_test_xml)
#remove the features of mamadroid
