...
def merge_two_dfs(df1,df2):#take two dfs, return them merged by the file name ([0])
        ...
        merge=pd.merge(df2, df1, on=df1.columns[0])
...
df_mal_train_full=merge_two_dfs(df_mal_train,drebin_pd_mal)
...
df_mal_test1=merge_two_dfs(df_mal_train,drebin_pd_mal1)#add features to test from drebin
df_mal_test2=merge_two_dfs(df_mal_train,drebin_pd_mal2)#add features to test from drebin
df_mal_test3=merge_two_dfs(df_mal_train,drebin_pd_mal3)#add features to test from drebin
...
mal_train_former,mal_test_former= train_test_split(df_mal_train, test_size=0.2)
mal_test_former["category"]=1
mal_test_former=merge_two_dfs_ben_mal(ben_test,mal_test_former)#add benign to the test mix
get_results(df_ben_train,df_mal_train,mal_test_former,fam,10/10,"former")
